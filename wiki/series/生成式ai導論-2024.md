...
- [【生成式AI導論 2024】第18講：有關影像的生成式AI (下) — 快速導讀經典影像生成方法 (VAE, Flow, Diffusion, GAN) 以及與生成的影片互動](https://www.youtube.com/watch?v=OYN_GvAqv-A) | [transcript](../../raw/youtube/transcripts/OYN_GvAqv-A.md)
- [【生成式AI導論 2024】第17講：有關影像的生成式AI (上) — AI 如何產生圖片和影片 (Sora 背後可能用的原理)](https://www.youtube.com/watch?v=5H2bVEmYDNg) | [transcript](../../raw/youtube/transcripts/5H2bVEmYDNg.md)
