...
1. Run `conda run -n hung-yi-lee python3 scripts/hungyi_kb.py graph build` after major transcript syncs.
...
6. Use `conda run -n hung-yi-lee python3 scripts/hungyi_kb.py graph query "<question>"` for structure-based navigation.
...
- `conda run -n hung-yi-lee python3 scripts/hungyi_kb.py sync-transcripts`
